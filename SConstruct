...
for var in ['FABRIC_DIR', 'FABRIC_SPLICE_VERSION', 'FABRIC_BUILD_OS', 'FABRIC_BUILD_ARCH', 'FABRIC_BUILD_TYPE', 'BOOST_DIR', 'ARNOLD_INCLUDE_DIR', 'ARNOLD_LIB_DIR', 'ARNOLD_VERSION']:
