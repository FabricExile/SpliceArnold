...
for var in ['FABRIC_CAPI_DIR', 'FABRIC_SPLICE_VERSION', 'FABRIC_BUILD_OS', 'FABRIC_BUILD_ARCH', 'FABRIC_BUILD_TYPE', 'BOOST_DIR', 'ARNOLD_INCLUDE_DIR', 'ARNOLD_LIB_DIR', 'ARNOLD_VERSION']:
...
(arnoldSpliceAlias, arnoldSpliceFiles) = SConscript(
  ...
  exports = {
    ...
    'FABRIC_BUILD_OS': os.environ['FABRIC_BUILD_OS'],
    'FABRIC_BUILD_ARCH': os.environ['FABRIC_BUILD_ARCH'],
    'STAGE_DIR': spliceEnv.Dir('.stage').Dir('Applications').Dir('FabricSpliceArnold'+os.environ['ARNOLD_VERSION']),
    'BOOST_DIR': os.environ['BOOST_DIR'],
    'ARNOLD_INCLUDE_DIR': os.environ['ARNOLD_INCLUDE_DIR'],
    'ARNOLD_LIB_DIR': os.environ['ARNOLD_LIB_DIR'],
    'ARNOLD_VERSION': os.environ['ARNOLD_VERSION']
  },
  variant_dir = spliceEnv.Dir('.build').Dir(os.environ['ARNOLD_VERSION'])
)

allAliases = [arnoldSpliceAlias]
